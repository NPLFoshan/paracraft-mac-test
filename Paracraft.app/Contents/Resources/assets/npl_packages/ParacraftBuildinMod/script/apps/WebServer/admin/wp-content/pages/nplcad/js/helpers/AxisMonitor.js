...
THREE.AxisMonitor = function (dom_name, w, h, radius) {
...
THREE.AxisMonitor.prototype.loadFont = function () {
    ...
    var self = this;
    loader.load('/wp-content/pages/nplcad/js/libs/threejs/fonts/helvetiker_regular.typeface.json', function (response) {
        self.font = response;
        self.createText();
    });
}
